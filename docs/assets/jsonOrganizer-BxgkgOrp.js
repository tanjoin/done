import{C as e,D as t,O as n,S as r,_ as i,b as a,d as o,f as s,i as c,n as l,o as u,p as d,t as f,v as p,w as m,x as h,y as g}from"./session-manager-3jDclcSU.js";n((()=>{t(),r(),a(),p(),m(),s(),c(),l();var n=class t extends HTMLElement{_tasks=[];static excludeGoogleTodoTasks(e){return e.filter(e=>e.sourceType!==`google-todo`)}static get NAME(){return`done-json-organizer`}connectedCallback(){this.render(),this.loadTasks(),this.setupEvents()}render(){this.innerHTML=`
      <main>
