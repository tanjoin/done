import{A as e,L as t,M as n,N as r,P as i,R as a,S as o,b as s,c,d as l,f as u,j as d,k as f,m as p,n as m,o as h,p as g,r as _,t as v,x as y,y as b}from"./google-auth-alert-NfLzaBZ7.js";a((()=>{t(),n(),u(),e(),i(),y(),h(),p(),m();var a=class e extends HTMLElement{_tasks=[];_googleAuthAlertController=null;static excludeGoogleTodoTasks(e){return e.filter(e=>e.sourceType!==`google-todo`)}static get NAME(){return`done-json-organizer`}connectedCallback(){this.render(),this._googleAuthAlertController=new v({root:this,ids:{statusId:`googleAuthStatus`,messageId:`googleAuthStatusMessage`,actionButtonId:`googleAuthStatusBtn`,dismissButtonId:`googleAuthDismissBtn`},onAction:()=>{document.querySelector(`#googleHeaderLoginBtn`)?.click()}}),this._googleAuthAlertController.setup(),this.loadTasks(),this.setupEvents(),document.addEventListener(g.EVENT_GOOGLE_RELOGIN_REQUIRED,()=>{this._googleAuthAlertController?.show(`Google認証の有効期限が切れました。Google に再ログインしてください。`)})}render(){this.innerHTML=`
      <main>
        ${_({statusId:`googleAuthStatus`,messageId:`googleAuthStatusMessage`,actionButtonId:`googleAuthStatusBtn`,dismissButtonId:`googleAuthDismissBtn`,actionLabel:`Google にログイン`,dismissAriaLabel:`Google認証通知を閉じる`})}
