import{A as e,D as t,F as n,I as r,M as i,O as a,_ as o,b as s,c,d as l,f as u,j as d,k as f,l as p,n as m,o as h,r as g,t as _,u as v,v as y,y as b}from"./google-auth-alert-Bo6HCIVe.js";r((()=>{n(),e(),v(),a(),i(),b(),h(),u(),m();var r=class e extends HTMLElement{_tasks=[];_googleAuthAlertController=null;static excludeGoogleTodoTasks(e){return e.filter(e=>e.sourceType!==`google-todo`)}static get NAME(){return`done-json-organizer`}connectedCallback(){this.render(),this._googleAuthAlertController=new _({root:this,ids:{statusId:`googleAuthStatus`,messageId:`googleAuthStatusMessage`,actionButtonId:`googleAuthStatusBtn`,dismissButtonId:`googleAuthDismissBtn`},onAction:()=>{document.querySelector(`#googleHeaderLoginBtn`)?.click()}}),this._googleAuthAlertController.setup(),this.loadTasks(),this.setupEvents(),document.addEventListener(l.EVENT_GOOGLE_RELOGIN_REQUIRED,()=>{this._googleAuthAlertController?.show(`Google認証の有効期限が切れました。Google に再ログインしてください。`)})}render(){this.innerHTML=`
      <main>
        ${g({statusId:`googleAuthStatus`,messageId:`googleAuthStatusMessage`,actionButtonId:`googleAuthStatusBtn`,dismissButtonId:`googleAuthDismissBtn`,actionLabel:`Google にログイン`,dismissAriaLabel:`Google認証通知を閉じる`})}
