import{A as e,C as t,E as n,S as r,T as i,a,b as o,h as s,i as c,k as l,l as u,m as d,n as f,p,r as m,s as h,t as g,w as _,x as v,y}from"./google-auth-alert-Cc1dCsWa.js";e((()=>{l(),_(),r(),o(),n(),d(),h(),a(),f();var e=class e extends HTMLElement{_tasks=[];_googleAuthAlertController=null;static excludeGoogleTodoTasks(e){return e.filter(e=>e.sourceType!==`google-todo`)}static get NAME(){return`done-json-organizer`}connectedCallback(){this.render(),this._googleAuthAlertController=new g({root:this,ids:{statusId:`googleAuthStatus`,messageId:`googleAuthStatusMessage`,actionButtonId:`googleAuthStatusBtn`,dismissButtonId:`googleAuthDismissBtn`},onAction:()=>{window.location.href=`settings.html`}}),this._googleAuthAlertController.setup(),this.loadTasks(),this.setupEvents(),document.addEventListener(c.EVENT_GOOGLE_RELOGIN_REQUIRED,()=>{this._googleAuthAlertController?.show(`Google認証の有効期限が切れました。設定画面で再ログインしてください。`)})}render(){this.innerHTML=`
      <main>
