import{A as e,C as t,D as n,E as r,S as i,T as a,_ as o,a as s,c,d as l,g as u,j as d,l as f,n as p,r as m,s as h,t as g,u as _,v,w as y}from"./google-auth-alert-_YZBgYvu.js";d((()=>{e(),a(),f(),t(),n(),o(),s(),l(),p();var d=class e extends HTMLElement{_tasks=[];_googleAuthAlertController=null;static excludeGoogleTodoTasks(e){return e.filter(e=>e.sourceType!==`google-todo`)}static get NAME(){return`done-json-organizer`}connectedCallback(){this.render(),this._googleAuthAlertController=new g({root:this,ids:{statusId:`googleAuthStatus`,messageId:`googleAuthStatusMessage`,actionButtonId:`googleAuthStatusBtn`,dismissButtonId:`googleAuthDismissBtn`},onAction:()=>{document.querySelector(`#googleHeaderLoginBtn`)?.click()}}),this._googleAuthAlertController.setup(),this.loadTasks(),this.setupEvents(),document.addEventListener(_.EVENT_GOOGLE_RELOGIN_REQUIRED,()=>{this._googleAuthAlertController?.show(`Google認証の有効期限が切れました。Google に再ログインしてください。`)})}render(){this.innerHTML=`
      <main>
        ${m({statusId:`googleAuthStatus`,messageId:`googleAuthStatusMessage`,actionButtonId:`googleAuthStatusBtn`,dismissButtonId:`googleAuthDismissBtn`,actionLabel:`Google にログイン`,dismissAriaLabel:`Google認証通知を閉じる`})}
