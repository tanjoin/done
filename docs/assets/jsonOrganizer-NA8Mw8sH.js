import{T as e,_ as t,b as n,c as r,g as i,h as a,i as o,l as s,m as c,n as l,u,v as d,w as f,x as p,y as m}from"./google-drive-service-BR5EmNtU.js";e((()=>{f(),m(),t(),a(),p(),s(),l();var e=class e extends HTMLElement{_tasks=[];static excludeGoogleTodoTasks(e){return e.filter(e=>e.sourceType!==`google-todo`)}static get NAME(){return`done-json-organizer`}connectedCallback(){this.render(),this.loadTasks(),this.setupEvents()}render(){this.innerHTML=`
      <main>
