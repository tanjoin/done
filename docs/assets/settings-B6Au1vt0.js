import{C as e,D as t,E as n,O as r,S as i,_ as a,a as o,b as s,d as c,g as l,i as u,l as d,n as f,o as p,r as m,s as h,t as g,u as _,v,x as y,y as b}from"./session-manager-Bnwk3NjC.js";import{a as x,c as S,d as C,i as w,l as T,n as E,o as D,r as O,t as k,u as A}from"./task-repository-kBSV8qrV.js";var j,M,N=r((()=>{a(),c(),u(),S(),j=[`https://www.googleapis.com/auth/calendar`,`https://www.googleapis.com/auth/calendar.events`,`https://www.googleapis.com/auth/drive.file`],M=class{static render(){return`
    ...
    `}static setup(e){let t=e.querySelector(`#overdueReferenceDateInput`),n=e.querySelector(`#overdueReferenceDateForm`),r=e.querySelector(`#displaySaveStatus`);!t||!n||(t.value=l.overdueReferenceDate,n.addEventListener(`submit`,e=>{e.preventDefault(),t.value&&(l.overdueReferenceDate=t.value,r&&(r.style.display=`inline`,setTimeout(()=>{r.style.display=`none`},2500)))}))}}})),R,z=r((()=>{a(),w(),D(),R=class e{static render(){return`
      ${e.renderSound()}
