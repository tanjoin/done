import{a as e,c as t,d as n,f as r,i,n as a,o,p as s,r as c,s as l,t as u}from"./local-storage-manager-DZ6mhuG2.js";import{a as d,i as f,n as p,o as m,r as h,t as g}from"./task-repository-C13ogIrp.js";var _,v=s((()=>{a(),_=class{static render(){return`
    ...
    `}async setup(){await this._taskRepository.loadTasks(),C.setup(this),_.setup(this),x.setup(this),y.setup(this,this._taskRepository)}};customElements.get(t.NAME)||customElements.define(t.NAME,t),document.addEventListener(`DOMContentLoaded`,async()=>{let n=document.querySelector(`.container`);if(!n)return;let r=document.createElement(c.NAME);r.active=`settings`,n.appendChild(r);let i=document.createElement(t.NAME);n.appendChild(i);let a=document.createElement(e.NAME);n.appendChild(a)})}))();