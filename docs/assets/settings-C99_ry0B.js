import{D as e,E as t,S as n,T as r,_ as i,a,b as o,d as s,g as c,i as l,l as u,n as d,o as f,r as p,s as m,t as h,u as g,v as _,w as v,x as y,y as b}from"./session-manager-tscVz3I7.js";import{a as x,c as S,d as C,i as w,l as T,n as E,o as D,r as O,t as k,u as A}from"./task-repository-DvjvljzE.js";var j=r((e=>{Object.defineProperty(e,"__esModule",{value:!0}),e.mergeTasksFromGoogleDrive=t;function t(e,t){let n=new Map(t.map(e=>[e.id,e]));return[...e.map(e=>{let t=n.get(e.id);return t?(n.delete(e.id),{...t,...e,history:{...t.history||{},...e.history||{}}}):e}),...n.values()]}})),M,N,P,F=t((()=>{i(),s(),l(),M=j(),S(),N=[`https://www.googleapis.com/auth/calendar`,`https://www.googleapis.com/auth/calendar.events`,`https://www.googleapis.com/auth/drive.file`],P=class{static render(){return`
