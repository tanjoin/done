import{a as e,c as t,d as n,f as r,i,n as a,o,p as s,r as c,s as l,t as u}from"./local-storage-manager-yXjt_qKa.js";import{_ as d,a as f,c as p,d as m,f as h,g,i as _,l as v,m as y,n as b,o as x,p as S,r as C,s as w,t as T,v as E}from"./task-repository-B7lLftrg.js";var D,O,k=s((()=>{a(),E(),_(),m(),D=[`https://www.googleapis.com/auth/calendar`,`https://www.googleapis.com/auth/calendar.events`,`https://www.googleapis.com/auth/drive.file`],O=class{static render(){return`
    ...
    `}static setup(e){let t=e.querySelector(`#overdueReferenceDateInput`),n=e.querySelector(`#overdueReferenceDateForm`),r=e.querySelector(`#displaySaveStatus`);!t||!n||(t.value=u.overdueReferenceDate,n.addEventListener(`submit`,e=>{e.preventDefault(),t.value&&(u.overdueReferenceDate=t.value,r&&(r.style.display=`inline`,setTimeout(()=>{r.style.display=`none`},2500)))}))}}})),P,F=s((()=>{a(),w(),v(),P=class e{static render(){return`
      ${e.renderSound()}
    ...
    `}async setup(){this._taskRepository.hydrateFromLocal(),I.setup(this),O.setup(this),M.setup(this),P.setup(this),A.setup(this,this._taskRepository),this._taskRepository.refreshFromCloudIfNeeded()}};customElements.get(t.NAME)||customElements.define(t.NAME,t),document.addEventListener(`DOMContentLoaded`,async()=>{let n=document.querySelector(`.container`);if(!n)return;let r=document.createElement(c.NAME);r.active=`settings`,n.appendChild(r);let i=document.createElement(t.NAME);n.appendChild(i);let a=document.createElement(e.NAME);n.appendChild(a)})}))();