...
export const TEMPORARY_FORM_GROUP_SUGGESTIONS_UPDATE = 'done-temporary-form-group-suggestions-update';
...
export class TemporaryForm extends HTMLElement {
    ...
    private setupDefaultDate(): void {
        (document.getElementById('date') as HTMLInputElement).value = DateHelper.today;
        (document.getElementById('endDate') as HTMLInputElement).value = '';
    }
